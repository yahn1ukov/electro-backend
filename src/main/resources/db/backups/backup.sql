...
INSERT INTO `charger_users` VALUES (2,'Electro','2022-06-14 21:27:28.436000','charger.electro@nure.ua',_binary '',_binary '','$2a$10$Dkmgb/weFsQV6Fwfj0XoWePI6.HB/d0lR2IJF4yC9Am9raNqAjq0e',NULL,'CHARGER','2022-06-14 21:27:28.436000',NULL);
...
CREATE TABLE `chargers` (
  ...
  `owner_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_ai0i9e7aw6lrrb4xijk11pe1o` (`code`),
...
INSERT INTO `station_users` VALUES (3,'Electro','2022-06-14 21:28:20.502000','station.electro@nure.ua',_binary '',_binary '','$2a$10$l5VAZi8QYTVy4quUY9lF.eEvs4/UEZ8E9lqO4iq6Dit4oxwKCsD92',NULL,'SERVICE','2022-06-14 21:28:20.502000',NULL);
...
INSERT INTO `users` VALUES (1,'2022-06-14 21:26:25.585000','admin@nure.ua','Admin',_binary '',_binary '','Admin','$2a$10$6rzcQjbl/fOnqdmfn10Hy.1g0xz8cXf.VjX/GuwMey.AcaD3lHjdC','ADMIN','2022-06-14 21:26:25.585000'),(4,'2022-06-14 21:31:03.445000','user@nure.ua','User',_binary '',_binary '','User','$2a$10$.alkNuZI2K8AFICdspf1v.fynk4Uy6yNQG4E1SzDjAMoxhS9kJy1S','USER','2022-06-14 21:31:03.445000'),(5,'2022-06-14 21:34:28.228000','moderator@nure.ua','Moderator',_binary '',_binary '','Moderator','$2a$10$Z7oBqHGCW7Y15ZKNKDdoJe9H.uXd/pCDBHzVcd71HCOdWHlXd4yEW','MODERATOR','2022-06-14 21:34:28.228000');
...
-- Dump completed on 2022-06-14 21:35:29
